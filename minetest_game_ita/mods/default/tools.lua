...
minetest.register_tool("default:axe_steel", {
	description = "Accetta di acciaio",
...
minetest.register_tool("default:axe_diamond", {
	description = "Accetta di diamante",
